...
PRODUCT_COPY_FILES += \
    vendor/fundamental/common/prebuilt/common/bin/fundamental-cts.sh:$(TARGET_COPY_OUT_PRODUCT)/etc/fundamental-cts.sh \
    vendor/fundamental/common/prebuilt/common/etc/init/fundamental-cts.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/fundamental-cts.rc
